class InitSchema < ActiveRecord::Migration[7.0]
  def up
    ...
    create_table "active_storage_variant_records", id: :uuid, default: -> { "gen_random_uuid()" } do |t| #  rubocop:disable Rails/CreateTableWithTimestamps
      t.uuid "blob_id", null: false
      t.string "variation_digest", null: false
      t.index ["blob_id", "variation_digest"], name: "index_active_storage_variant_records_uniqueness", unique: true
    end
    create_table "authentication_methods", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "person_id"
    ...
    create_table "furnitures", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.integer "slot"
    ...
    create_table "marketplace_cart_products", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "cart_id"
      t.uuid "product_id"
      t.integer "quantity"
      t.datetime "created_at", null: false
    ...
    create_table "marketplace_delivery_areas", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
    ...
    create_table "marketplace_order_notification_methods", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "marketplace_id"
    ...
    create_table "marketplace_orders", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "marketplace_id"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.uuid "shopper_id"
    ...
    create_table "marketplace_product_tax_rates", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "tax_rate_id"
      t.uuid "product_id"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    create_table "marketplace_products", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "marketplace_id"
      t.string "name"
    ...
    create_table "marketplace_shoppers", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "person_id"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.index ["person_id"], name: "index_marketplace_shoppers_on_person_id", unique: true
    end
    create_table "marketplace_tax_rates", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.float "tax_rate"
      t.string "label"
      t.uuid "marketplace_id"
      t.datetime "created_at", null: false
    ...
    create_table "space_agreements", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "space_id"
      t.string "name", null: false
      t.string "slug", null: false
    ...
    create_table "utility_hookups", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "space_id"
      t.string "name", null: false
    ...
    add_foreign_key "marketplace_order_notification_methods", "furnitures", column: "marketplace_id", validate: false
