...
import { SpacePage, SpaceEditPage, RoomEditPage, RoomPage } from "../harness/Pages.js";
import { RoomCardComponent } from "../harness/Components.js";
import { Space, Room, Actor, linkParameters, AccessCode, AccessLevel } from "../lib/index.js";
import assert$0 from "assert";
const assert = assert$0.strict;
Given("{a} {space} with {a} {accessLevel} {room}", async function (_, space, _1, accessLevel, room) {
...
When("{a} {actor} locks {a} {accessLevel} {room} in {a} {space} with {a} {accessCode}", async function (_a, actor, _a1, accessLevel, room, _a2, space, _a3, accessCode) {
...
Then("{a} {actor} may not enter {a} {accessLevel} {room} in {a} {space} after providing {a} {accessCode}",
/**
 *
 * @param {Actor} actor
...
Then("{a} {actor} may enter {a} {accessLevel} {room} in {a} {space} after providing {a} {accessCode}", function (_a1, actor, _a2, accessLevel, room, _a3, space, _a4, accessCode) {
...
Then("the {actor} does not see the {room}'s Door", async function (actor, room) {
...
Then("{a} {actor} is informed they need to set {a} {accessCode} when they are locking {a} {room}", async function (_a1, actor, _a2, accessCode, _a3, room) {
